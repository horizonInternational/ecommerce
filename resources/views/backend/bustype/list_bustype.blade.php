...
@section('content')
    ...
    <div class="col-lg-9 main-chart">
        <div>
            <h4><b>Bustype</b>&nbsp;&nbsp;&nbsp;<a href="{{route('createBustype')}}" class="btn btn-default">+ Add New</a></h4>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <th>
                                            <form action="{{route('showBustype')."/".$key->bustypes_id}}" method="get">
                                        ...
                                        <th>&nbsp;</th>
                                        <th>
                                            <form action="{{route('destroyBustype')}}" method="post" onsubmit=" return ConfirmDelete()">
                                                {{csrf_field()}}
